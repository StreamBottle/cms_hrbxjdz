...
(function ($, window) {
    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        init: function (elem, options) {
            if (elem.nodeName.toLowerCase() === "textarea") {
                ...
                var htmlarea = this.htmlarea = $("<div style='background: #fff'/>").append(iframe);
    ...
    jHtmlArea.defaultOptions = {
        ...
        toolbarText: {
            ...
            h1: "标题1", h2: "标题2", h3: "标题3", h4: "标题4", h5: "标题5", h6: "标题6", p: "段落",
            indent: "缩进", outdent: "减少缩进", horizontalrule: "插入水平线",
            justifyleft: "左对齐", justifycenter: "居中", justifyright: "右对齐",
            increasefontsize: "增大字体", decreasefontsize: "缩小字体", forecolor: "文字颜色",
            link: "插入链接", unlink: "删除链接", image: "插入图片",
            orderedlist: "插入有序列表", unorderedlist: "插入无序列表",
